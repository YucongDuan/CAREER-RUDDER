...
Open `release/ZHIDUO_2027_Client_17.0.0.html` directly in a browser. No account, model API, database, remote font, analytics script, or automatic application is required.

The software is decision support, not a hiring, admission, income, civil-service or postgraduate-exam predictor. Exact 2027 recruitment and examination dates must be verified against current official notices.
